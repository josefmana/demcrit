...
In this study, we applied three different types of criteria for diagnosing PDD on level I. The first was based on the original framework [@dubois2007], which included assessments of attention, executive function, visuospatial abilities, and memory and was based Mini-Mental State Examination [@folstein1975; @stepankova2014]. The second was based on the recent call for change of diagnostic guidelines [@kulisevsky2024], refining cognitive domain assessments to improve sensitivity to PD-related dementia, with specific items from the Montreal Cognitive Assessment (MoCA) utilized for this purpose. The third approach applied the Czech version of the shortened Montreal Cognitive Assessment (sMoCA) [@bezdicek2020], testing whether equivalent cognitive impairments can be reliably identified using a more time-efficient testing protocol.

Below, readers can find a structured table summarizing all three diagnostic criteria, facilitating a clearer comparison of their components and applicability.
