...
The Functional Activities Questionnaire (FAQ) [@bezdicek2016; @pfeffer1982] was administered to assess functional impairment. The Beck Depression Inventory-II (BDI-II) [@ciharova2020; @beck1996] and State-Trait Anxiety Inventory (STAI) [@spielberg1983; @mullner1980] were used to assess neuropsychiatric status. **BDI-II and STAI are a part of the standard methods in our pre-DBS protocol, having well-established psychometric properties in PD populations [@leentjens2000; @dissanayaka2010]. Other psychiatric scales data, such as the Neuropsychiatric Inventory, were not available for our retrospective dataset. However, all patients underwent a comprehensive evaluation by a trained neuropsychiatrist, excluding the presence of major depression, apathy, psychosis, and visual hallucinations, ensuring that confounding neuropsychiatric conditions were not present in our sample.**

## Diagnostic algorithms for probable Parkinson's Disease Dementia

In this study, we applied three distinct sets of diagnostic algorithms for probable PDD at Level I. The first set was based on the original framework [@dubois2007], which utilized the Mini-Mental State Examination (MMSE) as a global cognitive screening tool, supplemented by assessments of attention, executive function, visuospatial abilities, and memory. The second set of algorithms was based on the recent call for change of dementia diagnostic guidelines [@kulisevsky2024], which advocates for more sensitive cognitive domain assessments in the context of PD. This updated approach incorporated specific items from the Montreal Cognitive Assessment (MoCA). The third approach applied the Czech version of the shortened Montreal Cognitive Assessment (sMoCA) [@bezdicek2020], a time-efficient modification designed to measure global cognitive performance using a reduced testing protocol that omits items providing redundant information. **The sMoCA has been validated in Czech PD cohorts [@bezdicek2020] and shown to be sensitive to cognitive deficits while lowering patient burden [@roalf2017a]. Inclusion of the sMoCA in our study was motivated by its clinical utility in pre-surgical settings, where time restrictions and patients’ fatigue often limit the feasibility of longer assessments. Moreover, its inclusion allowed us to compare diagnostic performance across different screening lengths.**
...
A total of `r sum(data$incl)` patients were included. The sample included `r sex` men, with an average of `r age`, `r edu`, `r dur`, `r updrs_off` and `r updrs_on`. **Descriptive statistics for neuropsychiatric symptoms indicated mild depressive and anxiety symptoms in our cohort, with the average BDI-II of `r bdi`, average STAI X1 of `r staix1`, and average STAI X2 of `r staix2`. However, according to the psychiatric assessment, none of the patients with probable PDD was suffering major depressive disorder, delirium or other neuropsychiatric abnormalities that would disqualify the diagnosis.** Cognitive characteristics of the sample are summarized in @tbl-desc.
...
??Finally, whereas our study systematically investigated how varying definition of global deficit, impaired cognition and IADL deficit affect probable PDD classification, it did not explore associations of PDD diagnosis with its neuropsychiatric (e.g. anxiety profile) and biomarker correlates. Future studies would benefit from focusing on these aspects of PDD.??^[**JM: Why was the previous paragraph added instead of this one? This looks perfectly functional. The same goes largely for the IADL discussion, the original was better (in terms of resources and logical coherence) at most places.**]
