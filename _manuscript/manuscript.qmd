...
author-note:
  disclosures:
    ...
    **AZV grant NW26-04-00015 (potřebuji přesnou formulaci dedikace)**; IOCB TEC-H Foundation Martina Roeselova Memorial Fellowship"
...
Due to the retrospective nature of the study, some patients lacked one or more key measures required for the diagnosis of probable PDD by certain algorithms. Missing data were handled using the complete cases method. **Although this approach reduces statistical power, it ensures that comparisons between diagnostic algorithms are performed on identical patient subsets, thereby minimizing bias due to sample heterogeneity across pairwise analyses.**
