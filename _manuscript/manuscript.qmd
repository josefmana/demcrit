...
Currently, efforts are focused on refining this PDD diagnostic framework. A recent call for a change pinpoints limitations regarding the original criteria and suggest various updates to enhance their utility [@kulisevsky2024]. Proposed suggestions include replacement of the Mini Mental State Examination (MMSE) by the Montreal Cognitive Assessment (MoCA), which is more sensitive to PD specific cognitive impairment; expansion of instrumental activities of daily living (IADL) evaluation; inclusion of language assessment; recognition of anxiety as one **of** the neuropsychiatric symptoms relevant in PDD; and integration of biomarkers.
...
**Another limitation concerns the use of the FAQ questionnaire for IADL assessment. The FAQ is a subjective and informant-reliant measure, which may contain biased data. Moreover, its content can vary across sociocultural contexts, limiting cross-cultural transferability. For example, activities such as financial management, cooking or driving, are not uniformly performed across societies. Consequently, both the FAQ scores and diagnostic thresholds used to indicate IADL impairment may not be directly transferable between cultural settings [@odonald2025]. These factors may influence both the sensitivity and ecological validity of the functional criteria used [@bezdicek2011; @bezdicek2016b].**

**Furthermore, the FAQ scores may correlate with neuropsychological results of specific cognitive domains, particularly executive functions or memory [@vanrentergem2020; @moheb2017]. This overlap could artificially increase concordance between cognitive and functional capacity criteria. To address these concerns in future research, we suggest using a PD-specific questionnaire, such as the Penn Parkinson's Daily Activities Questionnaire-15 [@brennan2016] or generally more objective methods, preferably performance-based ones. Our results underscore the importance of IADL measurement for the PDD diagnosis. Therefore, we recommend using more reliable tools with high ecological validity.** For future research, we suggest the use of more objective, modernized tools for IADl assessment, such as performance-based methods [@schmitter-edgecombe2020] or questionnaire adaptations including items regarding gadgets use and digital literacy [@postema2024]. Our results emphasize the importance of IADL deficit for the PDD diagnosis, therefore, we suggest exploring more reliable tools with high ecological validity.
...
Future studies should aim to replicate our results on larger and different cohorts **with more heterogenous sample**. To make this process easier, the code used to generate our results is publicly available and easily applicable to similarly structured data.
