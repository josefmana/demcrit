...
This study comprehensively examined the diagnostic variability and validity of Level I criteria for PDD in DBS treatment candidates. By systematically comparing 68 diagnostic algorithms based on MMSE, MoCA, sMoCA, and Level II criteria, our findings highlight the significant influence of algorithm design.

## Variability in Prevalence Estimates

Our results showed a wide range in estimated PDD prevalence across 68 algorithms, ranging from 2.00% to 16.75%. Notably, estimates were substantially lower when using FAQ item 9 alone versus the full FAQ scale. This discrepancy underscores the diagnostic weight of IADL assessment. Our PDD rates were consistently lower compared to previous studied, demonstrating wide variability in reported PDD rate among PD patients. For instance, retrospective study reported a PDD rate of 19.7% [@rana2012], while a clinical investigation found even higher rate of around 30% [@aarsland2011]. A recent complex meta-analysis synthesizing global data placed the pooled rate at 26.30% [@sousa2022]. **The discrepancy is likely attributable to our DBS specific cohort, which differs in important characteristics, such as younger age of the patients [@rana2012]. / Compared to these estimates, our study reports generally lower PDD rates, likely reflecting differences in sample characteristics, diagnostic criteria, and methodology. [^3]**

[^3]: **MM to JM: Which sentence do you like better?**

## Concordance Between Diagnostic Algorithms

Our pairwise comparison of diagnostic algorithms showed that agreement was notably stronger among those using the same IADL operationalization (κ range from 0.75, SD = 0.13 to 0.86, SD = 0.09) compared to those using different IADL definitions (κ = 0.34, SD = 0.08). This demonstrates that even subtle methodological differences can yield substantially divergent diagnostic outcomes. Such findings are critical for clinicians relying on Level I criteria for eligibility decisions, as the choice of algorithm could lead to contradictory classifications of PDD.

## Predictive Validity Comaprison With Level II Criteria

When using Level II diagnosis as the reference, MoCA-based Level I algorithms, particularly those using Clock Drawing used to assess executive function, demonstrated the highest predictive accuracy. This supports recent proposals to modernize PDD diagnostic frameworks [@kulisevsky2024], favoring MoCA-derived components and broader functional assessment tools. In contrast, MMSE-based algorithms consistently underperformed, suggesting limited sensitivity in capturing the nuanced cognitive deficits characteristic of PDD.

The advantage of MoCA-based algorithm was particularly evident when using the FAQ total score to define functional impairment in comparison with using FAQ item 9 only. In these cases, the best-performing algorithms achieved accuracy rates of 94–99%, together with balanced sensitivity and specificity, reinforcing the clinical utility.

## Clinical Implications 

These findings have immediate implications for DBS candidacy assessment. Given that a diagnosis of PDD typically precludes surgical intervention, inconsistent application of diagnostic criteria can lead to inequitable access to the treatment. Our data emphasize the need for harmonized assessment protocols that balance sensitivity with specificity, particularly in high-stakes clinical decision-making.

Moreover, the relative success of multidomain assessments, such as Level II protocols or regression-based normative approaches, highlights the importance of psychometric rigor in diagnosing PDD. These approaches may serve as confirmatory tools in cases where Level I assessments yield ambiguous results.
...
This study systematically investigated the application of multiple Level I diagnostic criteria for PDD within a cohort of patients considered for DBS. The findings reveal substantial variability in PDD rates estimates, strongly influenced by the choice of cognitive screening instruments and the operationalization of functional impairment. The divergence observed across algorithms demonstrates the sensitivity of diagnostic outcomes to seemingly minor methodological choices.

The proposed revisions to the diagnostic framework [@kulisevsky2024] criteria offer enhanced sensitivity by leveraging MoCA-based components and broader IADL assessments. Conversely, overly conservative criteria, such as reliance on pill questionnaire (i.e. FAQ item 9 equivalence) may fail to detect meaningful functional decline and thus under-identify true cases of PDD presence.

Ultimately, this study contributes to the improving landscape of PDD diagnostics by offering empirical evidence for the refinement of Level I criteria and reinforcing the value of psychometric rigor in clinical neuropsychology. Future research should validate these operationalizations longitudinally and explore integration with biomarkers to further enhance diagnostic reliability.
