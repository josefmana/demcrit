...
Parkinson’s disease (PD) is a neurodegenerative disorder characterized by a progressive onset of motor symptoms, including rigidity, bradykinesia, postural instability and resting tremors. Beside motor symptoms, patients routinely suffer from non-motor impairments [@postuma2015]. Beyond these hallmark features, cognitive decline is a critical aspect of the disease trajectory, culminating in Parkinson’s disease dementia (PDD) in a substantial subset of patients [@meireles2012]

Epidemiological research underscores the demographic variability of PDD. In a retrospective chart review, 19.7% of PD patients met diagnostic criteria for dementia, with the majority (90%) aged 70 years or older—highlighting the strong influence of advancing age on PDD risk [@rana2012]. Similarly, a large-scale study found a PDD prevalence of 38.3% among 1,200 patients with PD, and reported that up to 77.2% exhibited some degree of cognitive impairment, ranging from mild cognitive impairment to PDD. Both age and disease duration were significant predictors of cognitive dysfunction [@oh2016].

Additional data further highlight the complex interaction of demographic variables in PDD prevalence. A comprehensive investigation found an overall PDD prevalence of 11.5%, which increased to 13.5% among individuals aged 60 and older. This study identified both age and disease duration as independent risk factors, while also revealing gender-specific patterns. Specifically, male patients exhibited a more significant increase in PDD prevalence between ages 60 and 80, whereas female patients showed increase only after age 80 [@cereda2016].

Despite its clinical relevance, the diagnosis of PDD remains complex. The original diagnostic criteria [@dubois2007], first formalized in 2006, were heavily influenced by frameworks established for Alzheimer’s disease (AD) owing to the absence of PD-specific biomarkers that could facilitate a biologically grounded diagnostic system. Although these criteria provided a valuable initial foundation, they lacked the specificity required to capture the distinct pathophysiological and cognitive features of PD-related dementia [@emre2007; @yamashita2023].
