...
Before starting, ensure that you have a local installation of the *demcrit* R package. If not, see the [package overview](../index.html) for installation instructions, or visit the package website's [reference list](https://josefmana.github.io/demcrit/reference/index.html) for function documentation.
