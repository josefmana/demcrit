...
Participants were assessed with both MMSE (Stepankova et al., 2014; Folstein et al., 1975) and MoCA (Kopecek et al., 2017; Nassredine et al., 2005) to measure overall cognitive performance. Moreover, a comprehensive neuropsychological assessment was performed in accordance with MDS Task Force Level 2 criteria for MCI in PD (Litvan et al., 2012). We described our battery including a regression based calculator for normative scores in another study (Bezdicek et al., 2017). Besides other neuropsychological tests, the comprehensive assessment employed Clock Drawing Test (CDT) and Letter Fluency. To establish cognitive performance in individual cognitive domains according to Level 1 criteria for PDD, we used test scores proposed by Dubois et al., (2007) and their analogues in MoCA, see Table A for details.
