...
#' is a helper with no inputs and is typically called within
#' \code{simulate_PDD_data}.
#'
#' @returns A list containing:
#'   \describe{
#'     \item{\code{Mu}}{Named numeric vector containing means for FAQ, MMSE,
#'     MoCA, and sMoCA.}
#'     \item{\code{Sigma}}{Named matrix containing variance-covariance of the
#'     variables (FAQ, MMSE, MoCA, and sMoCA).}
#'     \item{\code{cens}}{A matrix with named rows denoting scales (FAQ, MMSE,
#'     MoCA, and sMoCA) and two columns - the first containing lower bound, the
#'     second containing upper bound of each scale.}
#'     \item{\code{crits}}{A data.frame with four columns denoting IADL measure
#'     to use (`IADL`), threshold for the IADL measure (`IADL_thres`), cognitive
#'     measure to use (`cognition`), and threshold for the cognitive measure
#'     (`cognition_thres`). Score above `IADL_thres` and below `cognition_thres`
#'     are regarder to indicate PDD symptoms. Rownames contain algorithm names.}
#'   }
#'
