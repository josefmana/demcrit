...
table_estimands <- function() {
  tibble::tibble(
    ...
    Statement = c(
      ...
      "To evaluate the diagnostic concordance between Level I and Level II PDD algorithms.",
      "To identify minimal set of screening indexes that well approximate Level II PDD classification."
    ),
    Theoretical = c(
      "The true rate of PDD within the population of patients with PD.",
      "The variance of PDD rate estimates attributable to the diagnostic process itself, i.e., the extent to which different algorithms for probable PDD yield differing PDD rate estimates for the same population.",
      ...
      "A set of Level I probable PDD algorithms, ranked by the accuracy in predicting Level II PDD classification.",
      "Classification model of Level II PDD classification given a few screening indexes from Level I."
    ),
    Population = c(
      "DBS candidates with PD",
      "DBS candidates with PD",
      "DBS candidates with PD",
      "General population of patients with PD",
      "General population of patients with PD",
      "DBS candidates with PD",
      "DBS candidates with PD"
    ),
    Empirical = c(
      ...
      "Level I probable PDD algorithms ranking based on their accuracy of prediction PDD classification on Level II in the sample.",
      "Logistic regression model with reduced prediction set based on projective prediction on a reference model containing all available candidate predictors."
    ),
    Estimate = c(
      ...
      "Ranking of the available algorithms for probable PDD",
      "A set of optimal decision equation based on ROC analysis under different assumed real PDD prevalences."
    )
  ) |>
    gt_apa_table(
      grp = "RO",
