...
#'   rows via \code{gt::gt()}'s \code{groupname_col} parameter. Defaults to
#'   \code{NULL}.
#' @param nms An optional column name (as a string or symbol) to use for row
#'   names via \code{gt::gt()}'s \code{rowname_col} parameter. Defaults to
#'   \code{NULL}.
#' @param tit A character string specifying the table title. Will be converted
#'   to HTML format. Defaults to \code{""}.
#'
