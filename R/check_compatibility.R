...
#'
#' @returns If discrepancies are found, an informative message is printed and the function
#'    stops execution (e.g., via \code{stop()}). This function is intended to be used
