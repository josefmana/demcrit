...
#' dementia (PDD) across the full dataset. The set of criteria is generated
#' internally via the \code{specify_algorithms} function. Each patient is assessed
#' using each specification, and the corresponding diagnoses and supporting
...
#' \describe{
#'   \item{\code{algorithms}}{A tibble containing the full specification of all
#'   algorithms used.}
...
#'       \item Individual diagnostic flags corresponding to Table 2 in Dubois et
...
#' * [specify_algorithms()] runs internally to prepare a set of algorithms to be
#'   used.
#' * [diagnose_pdd_case()] runs internally to diagnose patients using a single
#'   algorithm.
#'
#' @references
#' Dubois, B., Burn, D., Goetz, C., Aarsland, D., Brown, R. G., Broe, G. A., ...
#' & Emre, M. (2007). Diagnostic procedures for Parkinson's disease dementia:
#' recommendations from the movement disorder society task force. Movement
#' disorders, 22(16), 2314-2324. \doi{10.1002/mds.21844}
#'
#' @examples
#' \dontrun{
